  ...
  return (
    <View style={styles.safeArea}>
      ...
      <View style={styles.toggleContainer}>
        <SettingToggle label="Dark Mode" value={darkMode} onValueChange={setDarkMode} />
        <SettingToggle label="Haptic Feedback" value={hapticFeedback} onValueChange={setHapticFeedback} />
      </View>
